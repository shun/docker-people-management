...
export class Init1602432769990 implements MigrationInterface {
    name = 'Init1602432769990'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("CREATE TABLE `official_position` (`id` int NOT NULL AUTO_INCREMENT, `title` varchar(32) NOT NULL DEFAULT '', `positionvalue` int NOT NULL, `delflg` tinyint NOT NULL, `start_date` date NULL, `end_date` date NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `official_rank` (`id` int NOT NULL AUTO_INCREMENT, `title` varchar(32) NOT NULL DEFAULT '', `rankvalue` int NOT NULL, `delflg` tinyint NOT NULL, `start_date` date NULL, `end_date` date NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("CREATE TABLE `user_position` (`user_cd` char(8) NOT NULL, `position_id` int NOT NULL, `section_id` int NOT NULL, `delflg` tinyint NOT NULL DEFAULT 0, `start_date` date NULL, `end_date` date NULL, PRIMARY KEY (`user_cd`, `position_id`, `section_id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `user_rank` (`user_cd` char(8) NOT NULL, `rank_id` int NOT NULL, `delflg` tinyint NOT NULL DEFAULT 0, `start_date` date NULL, `end_date` date NULL, PRIMARY KEY (`user_cd`, `rank_id`)) ENGINE=InnoDB");
